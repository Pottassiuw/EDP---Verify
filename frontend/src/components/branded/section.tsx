...
export function StatNumber({ className, ...props }: React.ComponentProps<'span'>): React.JSX.Element {
  return (
    <span
      className={cn(
        'text-[26px] font-semibold leading-none tracking-display tabular-nums text-text',
        className,
      )}
      {...props}
    />
  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-4">
      <div className="flex min-w-0 flex-col gap-[3px]">
        ...
        <h2 className="m-0 text-[21px] font-semibold leading-[1.15] tracking-display text-balance">
          {title}
        </h2>
