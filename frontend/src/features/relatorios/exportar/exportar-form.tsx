...
export function ExportarForm({
  ...
  return (
    <section className="edp-panel flex max-w-3xl flex-col gap-5">
      <TituloPainel
      ...
      <div className="flex flex-col gap-3">
        <span className="edp-eyebrow">Escopo do arquivo</span>
        ...
        <p className="edp-field edp-mono flex items-center truncate text-xs">{nomeArquivo}</p>
      </div>

      <div className="flex flex-col gap-3">
        <span className="edp-eyebrow">Blocos incluídos</span>
        <div className="grid gap-3 sm:grid-cols-2">
          {BLOCOS.map((bloco) => {
            ...
            return (
              <label
                key={bloco.id}
                className={`flex min-h-20 items-start gap-3 rounded-edp border p-3 ${
                  bloco.indisponivel
              ...
              >
                <input
                  ...
                  className="mt-0.5 size-4 rounded-edp-sm border-line-2 bg-bg-2"
                />
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Campo label="Busca"><p className="edp-field flex items-center truncate">{busca || 'Sem restrição'}</p></Campo>
      </div>
